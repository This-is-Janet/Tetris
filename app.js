document.addEventListener('DOMContentLoaded', ()=> {
    ...
    const theTetrominos = [lTetromino, tTetrominos, zTetromino, oTetromino, iTetromino];
    ...
    function moveLeft() {
        undraw();
        const isAtLeftEdge = currentTetro.some(index => (currentPotition + index) % tRow === 0); //why can't i declear this outside and use the variable in the rotation funciton?
